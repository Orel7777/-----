...
const Loader = () => {
  return (
    <StyledWrapper className="loader-container">
      <div className="logo-container">
        <img src="http://localhost:5173/logo.jpeg" alt="לוגו העסק - מדואלה" className="business-logo" />
      </div>
      <div className="pl">
      ...
      <div className="contact-info">
        <h3>מדואלה דקלה - טיפולי מגע ורפואה משלימה</h3>
        <p className="phone">053-3353203</p>
      </div>
    </StyledWrapper>
  );
}
...
const StyledWrapper = styled.div`
  ...
  align-items: center;
  background: linear-gradient(165deg, rgba(181, 218, 205, 0.95) 15%, rgba(181, 218, 205, 0.7) 50%, rgba(245, 242, 240, 0.95) 85%);
  z-index: 1000;
