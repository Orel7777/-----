  ...
  return (
    <PageBackground>
      ...
      <PrivacyContainer>
        ...
        <Section>
          <Paragraph>
            אנחנו, בשירותי רפואה משלימה וטיפולי עור, מעריכ׊׉ מאוד את הפרטיות שלך. לכן, ניסחנו מדיניות פרטיות זו כדי להבהיר לך בדיוק מה המידע שישמר על אודותיך, כיצד יעשה בו שימוש, למי תנתן גישה אליו, ומהן הדרכים בהן ניתן לקבל עותק מהמידע או לתקנו, במקרה שהוא אינו נכון או עדכני.
          </Paragraph>
          <Paragraph>
            מדיניות הפרטיות שלנו משתמשת בגופן עברית רב־מגדרית, ומציעה שפה מכילה לכל משתמש׊׍ השירות שלנו. היא נוצרה על ידי מחולל מדיניות הפרטיות של יהונתן קלינגר, אך יהונתן אינו ערב לטיבה של המדיניות, והוא לא בדק את הנתונים שהוזנו בטפסים. השימוש במדיניות פרטיות זו הוא על אחריות המשתמש׍ בלבד, ובהתאם למידע שהוזן. אם אינך רואה מדיניות זו כראוי, אנא דאגי להציגה באמצעות הגופן ובהתאם להדרכה המפורטת באתר "עברית רב־מגדרית".
          </Paragraph>
        </Section>
        <Divider />
        <Section>
        ...
        <Divider />
        <Section>
          <SectionTitle>האם את׌ חייב׍ למסור לנו מידע?</SectionTitle>
          <Paragraph>
            בהתאם לסעיף 11 לחוק הגנת הפרטיות, הרי שכל פניה ל׭נשים לקבלת מידע על אודותיה׋ מחייבת ליידע אות׋ האם יש חובה חוקית למסירת המידע, או שמסירת המידע תלויה ברצונ׎ הטוב של מוסר׍ המידע. במקרה זה, לא. אין חובה לספק את המידע, והעברת המידע תלויה ברצונ׎ החופשי של נושא׍ המידע.
          </Paragraph>
        </Section>
        <Divider />
        <Section>
          <SectionTitle>מה המידע הפרטי שאנחנו שומר׊׉ עלייך?</SectionTitle>
          <Paragraph>
            במשפט: כאשר את׌ משתמש׍ בשירות ויוצר׍ איתנו קשר, אנחנו עשוי׊׉ לשמור מידע על אודותיך. מידע זה יכול שיהיה מידע מזהה, ויכול שיהיה מידע שאינו מזהה. המידע המזהה שאנחנו נשמור הוא שמך המלא, פרטי התקשרות, כגון מספר הטלפון שלך וכתובת הדואר האלקטרוני שלך וכן כל מידע שיועבר לנו במהלך השירותים, או באמצעות טפסי יצירת קשר.
          </Paragraph>
        </Section>
        <Divider />
        <Section>
          ...
          <Paragraph>
            גם מידע שאינו מזהה עשוי עדיין לאפשר לאחר׊׉ ללמוד על אודותיך. לכן, חשוב שתדע שאנחנו שומר׊׉ את המידע הבא ואותו בלבד: מידע טכני, כגון סוג הדפדפן ומידע בנוגע לתוספים והגדרות במכשיר, מידע בנוגע לעמודים הנצפים, לשימוש בשירות וכדומה וכן מידע טכני שיתקבל במהלך התקשורת עמך.
          </Paragraph>
        </Section>
        <Divider />
        <Section>
          ...
          <Paragraph>
            הדרך בה מידע נאסף משפיעה על השיקולים בשימוש בשירותים שלנו. לכן, חשוב שנספק מידע בדיוק לגבי איסוף המידע שלך. אנחנו אוספ׊׉ את המידע שנמסר לנו בזמן השימוש בשירות שלנו בלבד.
          </Paragraph>
        </Section>
        <Divider />
        <Section>
          ...
          <Paragraph>
            הדרך בה נשתמש במידע עלייך משפיעה על הבחירות השונות, והם המטרות הרלוונטיות לעיבוד המידע. אנחנו לצרכי מתן השירות, לדיוור ישיר, מייצר׊׉ פרופילים לספק שירותים בצורה טובה יותר ואם נתבקש על ידך להעביר מידע לגורם מסוים, אנו נעשה זאת.
          </Paragraph>
        </Section>
        <Divider />
        <Section>
          ...
          <Paragraph>
            ככלל, ככל שלפחות ׭נשים יש גישה למידע על אודותיך, כך יותר טוב. במקרה של השירות שלנו, יש גישה לעובד׊׉ שלנו, תחת חובת סודיות, למשתמש׊׉ אחר׊׉ בשירות, אית׋ יצרת׋ קשר; כמו כן, יתכן כי במקרים מסוימים אנחנו נספק גישה זמנית למי שדרוש׌ לנו לאספקת השירות, תחת הסכם עיבוד מידע ספציפי.
          </Paragraph>
        </Section>
        <Divider />
        <Section>
        ...
        <Divider />
        <Section>
          <SectionTitle>האם את׌ יכול׌ לעיין במידע, לתקן או לעדכן מידע הנוגע אלייך?</SectionTitle>
          <Paragraph>
            בהתאם לסעיף 13 לחוק הגנת הפרטיות, זו זכותך לעיין במידע השמור עלייך. בהתאם לסעיף 14 לחוק, תוכל לעדכן או לתקן מידע שאינו עדכני עוד. על פי החוק הישראלי, אין חובה לאפשר לך למחוק מידע, אך אם תפנה לממונה על הגנת הפרטיות במאגר, ה׊א ׏וכל לספק לך מענה ספציפי לסוגיה זו.
          </Paragraph>
        </Section>
        <Divider />
        <Section>
          ...
          <Paragraph>
            עוגיה היא קובץ קטן שמושתל על המחשב שלך, ומאפשר לנו לחסוך מילוי פרטים כמו פרטי התחברות והתקשרות בכל עמוד. מצד שני, גורמ׊׉ עוינ׊׉ יכול׊׉ להשתמש בעוגיות כדי לעקוב אחריך לאורך הרשת. במקרה של השירות שלנו, אנחנו משתמש׊׉ בעוגיות שלנו בלבד.
          </Paragraph>
        </Section>
        <Divider />
        <Section>
          ...
          <Paragraph>
            נכון להיום, החוק הישראלי אינו מחייב בעל׊׍ מאגר מידע לעדכן אותך על אירועי אבטחת מידע שהתרחשו, אלא דורש כי הדיווח יגיע לרשות להגנת הפרטיות. אלא, שתמיד בעל׊׉ מאגר יכול׊׍ לספק לך הגנה טובה יותר. במקרה שלנו, אנחנו עומד׊׉ בחובה החוקית, ונדווח במקרה שבו רשות מוסמכת תורה לנו לדווח על אירוע אבטחה. תלונות תבחן לפי שיקול דעתנו.
          </Paragraph>
        </Section>
        <Divider />
        <Section>
          ...
          <Paragraph>
            ממונה הגנת הפרטיות במאגר ה׊א דקלה שליט מדואל. ניתן לצור עמ׎ קשר בכתובת הדואר האלקטרוני <a href="mailto:Dikla.sap@gmail.com">Dikla.sap@gmail.com</a>.
          </Paragraph>
        </Section>
        <Divider />
        <Section>
          ...
          <Paragraph>
            ככל שיהיו שינויים ועדכונים במסמך זה, אנו נביא אותם לידיעתך בהקדם, על ידי עדכון אתר האינטרנט שלנו, או על ידי שליחת הודעה לכלל המשתמש׊׉ שלנו.
          </Paragraph>
        </Section>
